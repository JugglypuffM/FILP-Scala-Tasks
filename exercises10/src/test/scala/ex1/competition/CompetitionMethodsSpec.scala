...
import ex1.competition.CompetitionMethods
import ex1.service.{TwitterService, TwitterServiceIO}
import org.scalatest.matchers.should.Matchers
import org.scalatest.wordspec.AsyncWordSpec
import ex1.service.domain.GetTweetResponse.Found
    ...
    "unlikeAll tweets" in {
      ...
      res.asserting(r =>
        r should matchPattern {
          case (Found(info1), Found(info2)) if info1.likedBy.isEmpty && info2.likedBy.isEmpty => ()
        }
      )
    }
